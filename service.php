...
<body class="bg-white text-gray-800">
    ...
    <div class="flex items-center space-x-4 relative group">
        ...
        <div class="relative">
            ...
            <a href="my_appointments.php" class="block px-4 py-2 text-gray-800 hover:bg-red-100">Appointmets</a>    
            <a href="Billing_Cust.php" class="block px-4 py-2 text-gray-800 hover:bg-red-100">Payments</a>
                ...
                <a href="customer_profile.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Settings</a>
