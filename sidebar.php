...
<div class="sidebar">
    ...
    <div class="nav-section">
        ...
        switch ($role) {
            case 'admin':
                echo "<a href='admin_modules/settings/settings.php'><i class='fas fa-cog'></i> Settings</a>";
                echo "<a href='admin/reports.php'><i class='fas fa-chart-bar'></i> Reports</a>";
            ...
            case 'staff':
                ...
                <div class='dropdown'>
                    ...
                    <div class='dropdown-menu'>
                        <a href='manage.php?status=pending'>Appointment Management</a>
                        <a href='Calendar_manager.php'>Calendar Manager</a>
                        <a href='bay_manager.php'>Bay Manager</a>
                    </div>
                </div>
                ...
                <div class='dropdown'>
                    ...
                    <div class='dropdown-menu'>
                        <a href='JOG.php '>Create Job Order</a>
                        <a href='all_job_orders.php'>Job Order List</a>
                    </div>
                </div><hr>";
                echo "<a href='Qoutation_Manager.php'><i class='fas fa-file-invoice'></i> Quotation Management</a>";
                echo "<a href='Billing.php'><i class='fas fa-file-invoice-dollar'></i> Billing</a>";
                echo "<a href='modules/appointments/CDM.php'><i class='fas fa-user'></i> Customer Data Management</a>";
                echo "<a href='/kcs/admin_modules/settings/settings.php'><i class='fas fa-cog'></i> Settings</a>";
                break;
            case 'inventory_manager':
                echo "<a href='modules/inventory/dashboard.php'><i class='fas fa-boxes'></i> Inventory Dashboard</a>";
                echo "<a href='manage_inventory.php'><i class='fas fa-warehouse'></i> Inventory Manager</a>";
                break;
            case 'mechanic':
