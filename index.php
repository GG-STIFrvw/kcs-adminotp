    ...
    <section id="services" class="py-16"> <!-- reduced from py-16 -->
        <div class="container mx-auto px-6">
            ...
            <div class="text-center mt-12 fade-in">
                ...
                <a href="service.php" class="bg-primary text-white px-8 py-3 rounded-full hover-lift font-semibold inline-block">Other Services</a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-3xl mx-auto space-y-4">
                ...
                <div class="faq-item fade-in">
                    ...
                    <div class="accordion-content bg-white rounded-lg shadow-md mt-2 px-6 py-6">
                        <p class="text-gray-800">You can book an appointment by creating an account on our website. If you already have one, simply log in to access the <a href='book.php'><b>booking page</b></a>.</p>
                    </div>
                </div>
            </div>
